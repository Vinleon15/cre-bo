...
# Сколько обращений к геокодеру позволено за сутки. У бесплатного тарифа
# Яндекса предел небольшой, и превышать его бессмысленно: ответом будет
# отказ. Исчерпан — привязка идёт по словам, как без геокодера вовсе.
GEO_DAILY_LIMIT = _int("GEO_DAILY_LIMIT", 100)
